...
const SignUpPage = () => {
  return (
    <div className="mt-[6rem] container mx-auto py-5 px-3 w-full flex flex-col h-screen items-center justify-start">
      ...
      <div className="border border-slate-700 flex flex-col gap-6 rounded-md p-2 w-full md:w-1/2">
